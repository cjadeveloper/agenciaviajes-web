...
INSERT INTO testimoniales (nombre, email, mensaje) VALUES 
('Cris','cris@email.com','La pasamos super!!!'),
('Carito','carito@email.com','El mejor viaje de mi vida! Voy a volver...'),
('Bombita Rodriguez','bombita@email.com','La pasamos bomba!!!!');
